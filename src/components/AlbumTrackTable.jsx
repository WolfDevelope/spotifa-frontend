...
const AlbumTrackTable = ({ tracks, album, artist }) => {
  ...
  return (
    <section className="bg-gradient-to-br from-[#8BCBE700] to-[#1171E2] rounded-xl shadow-lg max-w-4xl mx-auto overflow-x-auto mb-10">
        ...
        <tbody>
          {tracks.map((track, idx) => (
            <tr key={track.id} className="border-b border-gray-700 hover:bg-[#23203a]">
              ...
              <td className="px-3 py-2 text-right flex items-center justify-end gap-4">
