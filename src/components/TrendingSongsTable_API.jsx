                    ...
                    <div className="relative">
                      ...
                      {hoveredRow === song._id && (
                        <button
                          ...
                          className="absolute top-1/2 left-1/2 transform -translate-x-[85%] -translate-y-1/2 bg-purple-500 hover:bg-purple-600 text-white rounded-full w-9 h-9 flex items-center justify-center shadow-lg transition-opacity duration-200"
                          title="Nghe nhạc"
                        >
                          <svg
